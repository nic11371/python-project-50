...
@pytest.mark.parametrize('file1_name, file2_name, out, format', [
    ...
    ('file1.yaml', 'file2.json', 'except_result_diff_json.txt', 'json'),
    ('file1.json', 'file2.yml', 'except_result_diff_json.txt', 'json'),
    ('file1.json', 'file3.yaml', 'except_result_json.txt', 'json'),
